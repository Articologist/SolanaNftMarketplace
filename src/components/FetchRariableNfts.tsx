                                    ...
                                    <div className="flex justify-center ">
                                        <div className={styles.nftinfo}>
                                            <div className={styles.nftinfoname}> {nft?.blockchain}  </div>
                                                                          ...
                                                                          <div className={styles.nftinfoname}> {nft?.content?.available}  </div>
                                <div></div>
                               <button
                                            className="px-8 btn-sm btn-outline-success animate-pulse bg-gradient-to-r from-[#ffffff] to-[#ffffff]">
